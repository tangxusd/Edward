...
function App(): React.JSX.Element {
  ...
  return <main><h1>AI 剪视频工具</h1><WorkspaceSettings /><ProjectList onOpen={setProject} refreshToken={refreshToken} /><NewProjectDialog onCreated={created} /><PreviewCanvas project={project} onChange={updateProject} /><Timeline project={project} onChange={updateProject} /><SubtitleStylePanel project={project} onChange={updateProject} /><ModelSettings /><AiAnalysisPanel project={project} onApplied={updateProject} /><ExportDialog project={project} /><LibraryPanel /></main>;
}
