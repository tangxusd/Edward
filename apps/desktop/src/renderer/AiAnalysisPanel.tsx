...
export function AiAnalysisPanel({ project, onApplied }: { project?: Project; onApplied?: (project: Project) => void }): React.JSX.Element {
  ...
  const reloadSavedPlans = async () => { if (!project) { setSavedPlans([]); return; } setSavedPlans(await window.aiVideo.analysis.list(project.id)); };
